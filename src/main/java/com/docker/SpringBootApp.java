...
public class SpringBootApp {
	...
	public void sendMessage(String node, String json) {
		try {

			Map<String, String> m = gson.fromJson(json.replaceAll("'", ""), Map.class);
			m.put("node", node);
			simpMessagingTemplate.convertAndSend("/topic/eventDocker", m);
